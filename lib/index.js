...
var deep_storage_1 = require("deep-storage");
exports.deep = function (storage, paths, ownProps) { return function (BaseComponent) {
    var parsedPaths = deep_storage_1.parsePaths(paths);
