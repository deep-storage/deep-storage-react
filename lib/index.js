...
exports.connect = function (deepProps, ownProps) { return function (BaseComponent) {
    ...
    if (keys.length === 0)
        return /** @class */ (function (_super) {
            ...
            class_1.prototype.render = function () {
                return React.createElement(BaseComponent, __assign({}, (ownProps || {}), this.props));
            };
            return class_1;
        }(React.Component));
    var rootStorage = deepProps[keys[0]].root();
    var parsedPaths = {};
    ...
    return /** @class */ (function (_super) {
        ...
        class_2.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        ...
        class_2.prototype.render = function () {
            ...
            var newProps = Object.assign({}, anyProps, ownProps || {});
            for (var key in parsedPaths) {
